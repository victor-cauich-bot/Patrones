    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            foreach (string line in lines)
            {
                ...
                {
                    Console.WriteLine(palabras[0] + " Ocurrió en: " +palabras[1]);
                    ...
                    Console.WriteLine("Ocurrió hace ");
                    Console.WriteLine (comparacion);
                }
                else
                {
                    Console.WriteLine(palabras[0] + " Ocurrirá en: " + palabras[1]);
                    ...
                    Console.WriteLine("Ocurrirá a en: ");
                    Console.WriteLine(comparacion);
                }
